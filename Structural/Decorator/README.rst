...
.. caution::
   ...
   رعایت اصول Open/Closed و تک مسئولیتی به علت عدم تغییر ماهیت و ساختار کد در زمان افزودن امکانات و قابلیت های جدید و
جدا نگهداشتن کلاس اصلی و قابلیت های افزوده شده در کلاس های Decorator مجزای جدید و در نتیجه افزایش قابلیت نگهداری برنامه
...
پیاده سازی
-----------
قبل قبل از هر چیز یک interface مشترک داریم که کارش ارسال ناتیفیکیشن هست.
